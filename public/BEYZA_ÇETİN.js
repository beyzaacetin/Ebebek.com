  ...
  function createCarousel(products) {
      ...
      products.forEach(product => {
          ...
          productCard.innerHTML = `
              <div class="product-image" data-url="${product.url}">
                  <img src="${productImage}" alt="${product.name}" class="product-click" data-url="${product.url}" />
              ...
              <p class="title product-click" data-url="${product.url}">${product.name}</p>
              <div class="stars">
                  ${generateStars()}
              </div>
              <p class="price">
          ...
          // Ürün resmine veya ismine tıklanırsa yeni sekmede açılır
          productCard.querySelectorAll(".product-click").forEach(element => {
          ...
          // Favori butonuna tıklanınca turuncu yap
